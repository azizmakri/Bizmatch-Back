...
public class OpportuniteMarcheServiceIMP implements OpportuniteMarcheService {
    ...
    public String notif(DecouverteMarche decouverte, OpportuniteMarche opportunite) {
        String message = "Notification pour la découverte de marché: " + decouverte.getNom() + "de l'id: "+ decouverte.getId() + ":\n";
        ...
        message += "Vous pouvez considérer cette opportunité. sois accepter ou refuer le matching" ;
        return message;
    }
